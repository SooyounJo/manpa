...
export const narrativeBeats = [
  // Chapter 1 (inhale) — bg DBE7EA
  { id: '1-1', trigger: 'inhale', lines: ["오늘 몇 번의 파도가\n당신의 마음 속에 일었나요?", "아주 작은 흔들림부터,\n조금 더 크게 밀려온 순간들까지."], lineMs: 3000, bgColor: '#DBE7EA' },
  { id: '1-3', trigger: 'inhale', lines: ["지금은 그것들을 억지로 멀리\n보내지 않아도 됩니다.", "그저 천천히,\n하나씩 떠올려 봅니다."], lineMs: 3000, bgColor: '#DBE7EA' },
